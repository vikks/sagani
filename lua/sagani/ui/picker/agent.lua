--- ==============================================================================
--- Module: sagani.ui.picker.agent
---
--- Description:
---   Agent harness selection UI, dynamic model discovery, and reasoning effort selection
---   for sagani.nvim.
---
--- Responsibilities:
---   - Determine reasoning effort support (`supports_effort`) based on harness and model.
---   - Prompt for dynamic model choices and reasoning effort levels (`prompt_model_and_effort`).
---   - Present interactive agent harness selection menu (`select_agent_harness`).
--- ==============================================================================
